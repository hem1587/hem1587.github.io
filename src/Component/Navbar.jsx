...
const Navbar = () => {
  ...
  const OpenPDF = () => {
    ...
    const url = `https://drive.google.com/file/d/1s-BegkHxhHwRUt4tt13Sz11522yCPliZ/view?usp=drive_link`
