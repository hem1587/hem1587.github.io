...
const Tech_Stack = [
  ...
  {img : 'postman-icon-497x512-beb7sy75.png', text : 'Postman', w : '80px', w2 : '40px'},

  {img : 'Git-Icon-1788C.png', text : 'Git', w : '80px', w2 : '40px'},

  {img : 'githubblack.png', text : 'GitHub', w : '80px', w2 : '40px'},
...
const Skills = () => {
  return (
    <Box  border = '2px solid rgb(1, 16, 27)' id = 'skills'>
      ...
      <Heading color = 'rgb(0, 255, 162);' fontSize={35}><Text as = 'span' color = 'white'>My</Text> Skills & Tools</Heading>
